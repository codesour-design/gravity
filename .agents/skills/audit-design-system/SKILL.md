...
5. Present findings in the appropriate format based on the environment.
   Use JSON for Codex Desktop and machine-consumed review surfaces, markdown for Codex CLI and other chat-style environments (see Output Format Selection above).
