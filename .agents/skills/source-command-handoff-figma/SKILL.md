---
name: "source-command-handoff-figma"
...
Use this skill when the user asks to run the migrated source command `handoff-figma`.
...
Usa la mappa React→Figma in AGENTS.md come riferimento principale.
