...
|---|---|---|
| Token tema (colori, spacing, radius, font) | `prototipi/tokens.js` → `window.GRAVITY_THEME` | Variabili del file "Ant Design System for Gravity" |
...
| **Navbar** | `window.GravityNavbar` (script condiviso `../navbar.js`) | Componente **Navbar Gravity** — vedi `components/navbar.md` |
