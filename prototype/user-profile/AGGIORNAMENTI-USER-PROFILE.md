...
> **Scopo:** tradurre il nuovo design fatto su **Figma Make** (`reference/App.tsx`)
> in istruzioni per aggiornare il prototipo esistente `prototype/user-profile/index.html`.
>
...
>
> Fonte nuovo design: `reference/App.tsx`
> File da aggiornare: `prototype/user-profile/index.html`
...
sono in `reference/App.tsx`, costante `TENANTS`
