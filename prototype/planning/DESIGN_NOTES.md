...
> **Documento storico** — fotografia del redesign all'iterazione "nuovarotta" (poi consolidata in
> `planning/`), a confronto con il prodotto in produzione. Il prototipo è evoluto oltre questa
> fotografia (es. mappa di nuovo Google Maps, stati ridotti a Bozza / In trattativa / Completata):
> **lo stato corrente è descritto da `COMPONENTI.md` (UI) e `RICERCA.md` (ricerca/filtri)**.
> Resta la fonte del confronto col prodotto reale e dei punti aperti (tabella in fondo, con
> annotato ciò che l'evoluzione ha già risolto).
...
| 2 | ~~La categoria WEB è definitivamente fuori dal modulo Planning?~~ **Superata** — il prototipo corrente ha solo OOH/DOOH; resta aperta solo l'eventuale roadmap di un modulo Web | Scope |
| 3 | ~~I due nuovi stati corrispondono a fasi reali del processo?~~ **Superata** — modello ridotto a 3 stati: Bozza / In trattativa / Completata | Workflow |
...
| 11 | ~~Il passaggio da Google Maps a Leaflet è intenzionale?~~ **Risolta** — il prototipo corrente è tornato a Google Maps | Infrastruttura |
...
| 28 | I nomi delle KPI card usano il linguaggio corretto del team? (card correnti: Da prendere in carico / Le mie bozze / In trattativa) | Nomenclatura |

---

## Modello di ricerca e filtro

> Sezione spostata: il comportamento completo di zone, POI, raggio, intersezione zona×POI e
> filtri avanzati è specificato in **`RICERCA.md`** (organizzato per user story), che è la fonte
> canonica e più aggiornata.
