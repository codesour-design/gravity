...
Documento tecnico-funzionale che descrive il comportamento completo del sistema di ricerca, filtri e suggerimenti nel prototipo `planning`. Organizzato per user story.
